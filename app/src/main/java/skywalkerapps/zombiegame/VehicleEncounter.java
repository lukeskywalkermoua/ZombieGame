...
public class VehicleEncounter extends AppCompatActivity{
    ...
    //Stores an int generated by the createRandomNum() method
    private int randomNum;

    //Generates a random integer 0 through 9 (supposedly 10% chance)
    ...
    //Simplifies making a toast text multiple times, all you
    //do is pass in a string in the parameter of the method makeToast()
    private void makeToast(String toastString) {
        Toast.makeText(VehicleEncounter.this, toastString, Toast.LENGTH_LONG).show();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOptionA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(randomNum == 0) {
                    makeToast(vehicleScene.resultOne());
                    ...
                    makeToast(vehicleScene.resultTwo());
        ...
        buttonOptionB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Ten percent chance that randomNum is 0
                if(randomNum == 0) {
                    makeToast(vehicleScene.resultThree());
                    //if player is dead, show death screen
                    startActivity(deathIntent);
                    //Kill the stack
                    finish();
